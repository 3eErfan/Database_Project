...
public class userDAO {
	...
	public void insertNewTree(String photo_1, String photo_2, String photo_3, String size, String hight,
			String location, String note, int request_id) throws SQLException {
		connect_func();
		String sql = "insert into  Trees(photo_1, photo_2, photo_3, size, hight, location, note, cost, request_id) values (?,?,?,?,?,?,?,?,?)";
		preparedStatement = (PreparedStatement) connect.prepareStatement(sql);
		...
		preparedStatement.setInt(9, request_id);
	...
	public String msgBox(int request_id, int userId) throws SQLException {
		...
		if (!is_admin(userId)) {
			...
			if (stat.equals("open"))
				htmlTable.append(
						" <input type=\"button\" value=\"Cancel Request\" onclick=\"document.getElementById('topicInput').disabled=true; document.getElementById('messageInput').disabled=true; document.getElementById('messageForm').action='rejectRequest'; document.getElementById('messageForm').submit();\" />\n");
			if (stat.equals("quote")) {
				htmlTable.append(
						" <input type=\"button\" value=\"Reject and Cancel Request\" onclick=\"document.getElementById('topicInput').disabled=true; document.getElementById('messageInput').disabled=true; document.getElementById('messageForm').action='rejectRequest'; document.getElementById('messageForm').submit();\" />\n");
				htmlTable.append(
...
//				htmlTable.append(" <input type=\"submit\" value=\"Send as Quote\" onclick=\"document.getElementById('messageForm').action='sendQuote';\" />\n");
				...
				htmlTable.append(" <input type=\"button\" value=\"Reject Request\" onclick=\"document.getElementById('topicInput').disabled=true; document.getElementById('messageInput').disabled=true; document.getElementById('messageForm').action='rejectRequest'; document.getElementById('messageForm').submit();\" />\n");
				}
	...
	public void init() throws SQLException, FileNotFoundException, IOException {
		...
		String[] USERS = {
				("insert into User(email, firstName, lastName, password, adress_street_num, adress_street, adress_city, adress_state, adress_zip_code, phonenumber,credit_no,credit_cvv,credit_year,credit_month)"
						...
						+ "('x', 'Margarita', 'Lawson','x',  '1234', 'ivan street', 'tata','CO','12561','1000', '4916-4811-5814-8111' , 654 , 27, 4),"
		...
		String[] REQUESTS = { 
			    ...
			    + "values ( '2021-06-14 08:00:00' , 'open'      ,1 ,100 ,0 , 1),"
			    + "       ( '2021-06-14 09:15:00' , 'open'      ,1 ,100 ,0 , 3),"
			    + "       ( '2021-06-14 10:30:00' , 'rejected'  ,1 ,100 ,0 , 3),"
			    + "       ( '2021-06-14 11:45:00' , 'rejected'  ,1 ,100 ,0 , 3),"
			    + "       ( '2021-06-14 12:00:00' , 'quote'     ,1 ,100 ,0 , 4),"
			    + "       ( '2021-06-14 13:15:00' , 'quote'     ,1 ,100 ,0 , 5),"
			    + "       ( '2021-06-14 14:30:00' , 'accepted'  ,1 ,100 ,0 , 6),"
			    + "       ( '2021-06-14 15:45:00' , 'done'      ,1 ,100 ,0 , 7),"
			    + "       ( '2021-06-14 17:00:00' , 'done'      ,1 ,100 ,0 , 8);")
			};

			String[] Chats = { 
			    ("insert into Chats(msg_date, msg_topic, msg_content, who_sent, request_id)"
			    + "values ('2021-06-14 08:15:00', 'some new topic', 'Hi, here is my request. Please consider it ASAP', 'user'   ,1),"
			    + "       ('2021-06-14 09:30:00', 'some new topic', 'Hi, here is my request. Please consider it ASAP', 'user'   ,2),"
			    + "       ('2021-06-14 10:45:00', 'some new topic', 'Hi, here is my request. Please consider it ASAP', 'user'   ,3),"
			    + "       ('2021-06-14 11:00:00', 'some new topic', 'sorry I cannot do it.'                            , 'admin'   ,3),"
			    + "       ('2021-06-14 12:15:00', 'some new topic', 'Hi, here is my request. Please consider it ASAP', 'user'   ,4),"
			    + "       ('2021-06-14 13:30:00', 'some new topic', 'sorry I cannot do it.'                            , 'admin'   ,4),"
			    + "       ('2021-06-14 14:45:00', 'some new topic', 'Hi, here is my request. Please consider it ASAP', 'user'   ,5),"
			    + "       ('2021-06-14 15:00:00', 'some new topic', 'sure, it will cost you $250. Is that OK?'        , 'admin'   ,5),"
			    + "       ('2021-06-14 16:15:00', 'some new topic', 'Hi, here is my request. Please consider it ASAP', 'user'   ,6),"
			    + "       ('2021-06-14 17:30:00', 'some new topic', 'sure, it will cost you $250. Is that OK?'        , 'admin'   ,6),"
			    + "       ('2021-06-14 18:45:00', 'some new topic', 'Hi, here is my request. Please consider it ASAP', 'user'   ,7),"
			    + "       ('2021-06-14 19:00:00', 'some new topic', 'sure, it will cost you $250. Is that OK?'        , 'admin'   ,7),"
			    + "       ('2021-06-14 20:15:00', 'some new topic', 'Sounds good Let\\'s close the deal.'             , 'user'   ,7),"
			    + "       ('2021-06-14 21:30:00', 'some new topic', 'Hi, here is my request. Please consider it ASAP', 'user', 7);" ) };


		
		String[] Trees = { ("insert into Trees(photo_1, photo_2, photo_3, size, hight, location, note, cost, request_id)"
				+ "values ('pic1.jpg','pic2.jpg','pic3.jpg','4 inch','10 feet','45 feet far','some note...',0,1),"
				+ "('pic3.jpg','pic1.jpg','pic2.jpg','4 inch','10 feet','10 feet far','some note...',0,2),"
				+ "('pic3.jpg','pic1.jpg','pic2.jpg','4 inch','10 feet','10 feet far','some note...',0,3),"
				+ "('pic3.jpg','pic1.jpg','pic2.jpg','4 inch','10 feet','10 feet far','some note...',0,4),"
				+ "('pic3.jpg','pic1.jpg','pic2.jpg','4 inch','10 feet','10 feet far','some note...',0,5),"
				+ "('pic3.jpg','pic1.jpg','pic2.jpg','4 inch','10 feet','10 feet far','some note...',0,6),"
				+ "('pic3.jpg','pic1.jpg','pic2.jpg','4 inch','10 feet','10 feet far','some note...',0,7),"
				+ "('pic3.jpg','pic1.jpg','pic2.jpg','4 inch','10 feet','10 feet far','some note...',0,8);") };
